# Views package for website app 

# Import all views from the views package
from .public import HomeView, ContactFormView, handler404, handler500
from .services import ServiceCatalogueView, ServiceDetailPartial, ServiceTaskDetailPartial, ServiceListView
from .blog import BlogIndexView, BlogPostView
from .help_center import HelpCenterView, HelpCenterSearch, HelpArticleView
...
# Additional views needed by URLs
